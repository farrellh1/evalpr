...
Curated from durable engineering literature. **The runtime source of truth is `src/default-principles.ts`.** This file exists for human curation and explanation only.
...
- *Software Engineering at Google* — Winters/Manshreck/Wright (real tradeoffs, scale realities)
- *Effective TypeScript* — Vanderkam (stack-specific, evidence-based)
- *Clean Code* — Martin (selectively, naming + clarity philosophy only)
